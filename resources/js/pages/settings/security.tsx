                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Anda akan diminta memasukkan PIN acak yang aman saat login, yang bisa Anda dapatkan dari aplikasi pendukung TOTP di ponsel Anda.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Saat Anda mengaktifkan otentikasi dua faktor, Anda akan diminta memasukkan PIN aman saat login. PIN ini bisa Anda dapatkan dari aplikasi pendukung TOTP di ponsel Anda.
                            </p>

...
export default function IncomingDocuments({ documents = { data: [], links: [] }, filters }: Props) {
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Kelola arsip surat masuk.
                        </p>
                    </div>
                    <div className="flex flex-col gap-2 sm:flex-row">
                        <Button onClick={() => setIsIncomingModalOpen(true)} className="w-full sm:w-auto">
                            <MailOpen className="mr-2 h-4 w-4" /> Registrasi Surat Masuk
                        </Button>
                    </div>
                </div>
                        ...
                        <table className="hidden md:table w-full text-sm">
                            <thead>
                                <tr className="border-b bg-muted/50 transition-colors">
                                    ...
                                    <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Diterima Pada</th>
